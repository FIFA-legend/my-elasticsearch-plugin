...
public class Netty4Transport extends TcpTransport {
    ...
    protected class ClientChannelInitializer extends ChannelInitializer<Channel> {
        ...
        protected void initChannel(Channel ch) throws Exception {
            ...
            Recycler<BytesRef> recycler = Recyclers.concurrentDeque(new AbstractRecyclerC<>() {
                @Override
                public BytesRef newInstance() {
                    return new BytesRef(new byte[BYTE_PAGE_SIZE]);
                }

                @Override
                public void recycle(BytesRef value) {
                    // nothing to do
                }
            }, 10);
            ch.pipeline().addLast("dispatcher", new Netty4MessageChannelHandler(recycler, Netty4Transport.this));
        }
